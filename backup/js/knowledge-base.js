...
const KNOWLEDGE_BASE = {
    // 天干五行属性
    TIANGAN: {
        '甲': { element: '木', yinYang: '阳', nature: '参天大树', desc: '甲木为参天大树，性格刚直、有领导力' },
        '乙': { element: '木', yinYang: '阴', nature: '花草藤蔓', desc: '乙木为花草藤蔓，性格柔和、善于变通' },
        '丙': { element: '火', yinYang: '阳', nature: '太阳之火', desc: '丙火为太阳之火，性格热情、光明磊落' },
        '丁': { element: '火', yinYang: '阴', nature: '灯烛之火', desc: '丁火为灯烛之火，性格温和、心思细腻' },
        '戊': { element: '土', yinYang: '阳', nature: '城墙之土', desc: '戊土为城墙之土，性格稳重、诚实守信' },
        '己': { element: '土', yinYang: '阴', nature: '田园之土', desc: '己土为田园之土，性格包容、养育万物' },
        '庚': { element: '金', yinYang: '阳', nature: '刀剑之金', desc: '庚金为刀剑之金，性格刚毅、果断决绝' },
        '辛': { element: '金', yinYang: '阴', nature: '首饰之金', desc: '辛金为首饰之金，性格精致、追求完美' },
        '壬': { element: '水', yinYang: '阳', nature: '江河之水', desc: '壬水为江河之水，性格奔放、智慧深邃' },
        '癸': { element: '水', yinYang: '阴', nature: '雨露之水', desc: '癸水为雨露之水，性格含蓄、滋润万物' }
    },

    // 地支五行属性
    DIZHI: {
        '子': { element: '水', yinYang: '阳', hidden: ['癸'], desc: '子水为阳水，藏癸水' },
        '丑': { element: '土', yinYang: '阴', hidden: ['己', '癸', '辛'], desc: '丑土为湿土，藏己土、癸水、辛金' },
        '寅': { element: '木', yinYang: '阳', hidden: ['甲', '丙', '戊'], desc: '寅木为阳木，藏甲木、丙火、戊土' },
        '卯': { element: '木', yinYang: '阴', hidden: ['乙'], desc: '卯木为阴木，藏乙木' },
        '辰': { element: '土', yinYang: '阳', hidden: ['戊', '乙', '癸'], desc: '辰土为湿土，藏戊土、乙木、癸水' },
        '巳': { element: '火', yinYang: '阴', hidden: ['丙', '庚', '戊'], desc: '巳火为阴火，藏丙火、庚金、戊土' },
        '午': { element: '火', yinYang: '阳', hidden: ['丁', '己'], desc: '午火为阳火，藏丁火、己土' },
        '未': { element: '土', yinYang: '阴', hidden: ['己', '丁', '乙'], desc: '未土为燥土，藏己土、丁火、乙木' },
        '申': { element: '金', yinYang: '阳', hidden: ['庚', '壬', '戊'], desc: '申金为阳金，藏庚金、壬水、戊土' },
        '酉': { element: '金', yinYang: '阴', hidden: ['辛'], desc: '酉金为阴金，藏辛金' },
        '戌': { element: '土', yinYang: '阳', hidden: ['戊', '辛', '丁'], desc: '戌土为燥土，藏戊土、辛金、丁火' },
        '亥': { element: '水', yinYang: '阴', hidden: ['壬', '甲'], desc: '亥水为阴水，藏壬水、甲木' }
    },
    ...
    // 十神含义
    SHISHEN_DESC: {
        '比肩': { desc: '兄弟姐妹、朋友、同事', nature: '独立、自主、固执', detail: '比肩代表与自己同类的力量，象征兄弟姐妹、朋友、同事等平辈关系。性格上表现为独立自主、有主见，但也可能过于固执己见。' },
        '劫财': { desc: '竞争、争夺、破财', nature: '豪爽、冒险、冲动', detail: '劫财代表与自己争夺的力量，象征竞争、争夺、破财等。性格上表现为豪爽大方、喜欢冒险，但也容易冲动行事。' },
        '食神': { desc: '才华、享受、子女', nature: '温和、艺术、口福', detail: '食神代表我生之物，象征才华、享受、子女、口福等。性格上表现为温和善良、有艺术天赋，懂得享受生活。' },
        '伤官': { desc: '才华、叛逆、创新', nature: '聪明、叛逆、口才', detail: '伤官代表我生之物但过于极端，象征才华、叛逆、创新等。性格上表现为聪明机智、有创造力，但也可能叛逆不羁、口无遮拦。' },
        '偏财': { desc: '横财、父亲、情人', nature: '慷慨、善交际、风流', detail: '偏财代表我克之物但不完全占有，象征横财、父亲、情人等。性格上表现为慷慨大方、善于交际，但也可能风流多情。' },
        '正财': { desc: '妻子、正当收入、财产', nature: '节俭、务实、保守', detail: '正财代表我克之物且完全占有，象征妻子、正当收入、财产等。性格上表现为节俭务实、稳重保守，重视物质生活。' },
        '偏印': { desc: '继母、偏门学问、孤独', nature: '敏感、孤僻、多疑', detail: '偏印代表生我之物但不完全付出，象征继母、偏门学问、孤独等。性格上表现为敏感多疑、喜欢独处，有特殊的兴趣爱好。' },
        '正印': { desc: '母亲、学业、贵人', nature: '仁慈、好学、依赖', detail: '正印代表生我之物且完全付出，象征母亲、学业、贵人等。性格上表现为仁慈善良、好学上进，但也可能过于依赖他人。' },
        '七杀': { desc: '偏夫、压力、小人', nature: '威严、果决、暴躁', detail: '七杀代表克我之物且力量强大，象征偏夫、压力、小人等。性格上表现为威严果断、有魄力，但也容易暴躁易怒。' },
        '正官': { desc: '丈夫、上司、官职', nature: '正直、守法、稳重', detail: '正官代表克我之物且有节制，象征丈夫、上司、官职等。性格上表现为正直守法、稳重可靠，重视规则和秩序。' }
    },
    ...
    // 日主特性
    DAY_MASTER: {
        '甲': { desc: '甲木为参天大树，生于春季则枝叶繁茂，生于秋季则易受金克。甲木之人性格刚直，有领导力，为人正直，但可能过于固执。', element: '木', nature: '阳' },
        '乙': { desc: '乙木为花草藤蔓，柔韧性强，善于攀附。乙木之人性格柔和，善于变通，适应能力强，但可能缺乏主见。', element: '木', nature: '阴' },
        '丙': { desc: '丙火为太阳之火，光芒万丈，照亮万物。丙火之人性格热情开朗，光明磊落，有奉献精神，但可能过于急躁。', element: '火', nature: '阳' },
        '丁': { desc: '丁火为灯烛之火，虽然光芒有限但持久稳定。丁火之人性格温和，心思细腻，有耐心，但可能缺乏魄力。', element: '火', nature: '阴' },
        '戊': { desc: '戊土为城墙之土，厚重稳固，能够承载万物。戊土之人性格稳重可靠，诚实守信，有包容心，但可能过于保守。', element: '土', nature: '阳' },
        '己': { desc: '己土为田园之土，肥沃滋养，养育万物。己土之人性格温和包容，善于照顾他人，但可能过于软弱。', element: '土', nature: '阴' },
        '庚': { desc: '庚金为刀剑之金，锋利坚硬，能够切割万物。庚金之人性格刚毅果断，有决断力，但可能过于冷酷。', element: '金', nature: '阳' },
        '辛': { desc: '辛金为首饰之金，精致美丽，价值珍贵。辛金之人性格精致，追求完美，有艺术品味，但可能过于计较。', element: '金', nature: '阴' },
        '壬': { desc: '壬水为江河之水，奔流不息，浩瀚无垠。壬水之人性格奔放不羁，智慧深邃，善于思考，但可能过于随性。', element: '水', nature: '阳' },
        '癸': { desc: '癸水为雨露之水，滋润万物，细水长流。癸水之人性格含蓄内敛，善于思考，有智慧，但可能过于消极。', element: '水', nature: '阴' }
    },
...
// 获取十神
function getShishen(dayMaster, targetStem) {
    ...
    // 我克
    const restrainMap = { '木': '土', '火': '金', '土': '水', '金': '木', '水': '火' };
    ...
    // 克我
    const restrainedByMap = { '木': '金', '火': '水', '土': '木', '金': '火', '水': '土' };
